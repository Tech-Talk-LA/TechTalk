...
export default function Signup({ navigation }) {
  ...
  function validateForm() {
    ...
    // if all one checkbox is false alert to fill a checkbox and return false
    const checkBoxFieldValidation = Object.values(checkBoxData).some(
      (languages) => languages
    );
  ...
  const listItems = Object.keys(checkBoxData).map((
    listItem,
    i //list item: python javascript etc
  ) => (
    <ListItem>
      <CheckBox
        key={i}
        onPress={() =>
          listItem
            ? setCheckboxData({ ...checkBoxData, python: false })
            : setCheckboxData({ ...checkBoxData, python: true })
        }
        checked={listItem}
      />
      <Body>
    ...
    <Container>
      <Content>
        <Form>
          ...
          <Item last>
            <Input
              onChangeText={(text) => setConfirmPWInput(text)}
          ...
          >
            ...
            <Right>
              <Radio selected={activeRadio === 'python'} />
            </Right>
          </ListItem>
          <ListItem
            onPress={() => {
          ...
          >
            ...
            <Right>
              <Radio selected={activeRadio === 'javascript'} />
            </Right>
          </ListItem>
          <ListItem
            onPress={() => {
          ...
          >
            ...
            <Right>
              <Radio selected={activeRadio === 'ruby'} />
            </Right>
          </ListItem>
          <ListItem
            onPress={() => {
          ...
          >
            ...
            <Right>
              <Radio selected={activeRadio === 'golang'} />
            </Right>
          </ListItem>
          <ListItem onPress={() => setActiveRadio('cplusplus')}>
            ...
            <Right>
              <Radio selected={activeRadio === 'cplusplus'} />
            </Right>
          </ListItem>
          ...
          >
            <CheckBox checked={checkBoxData.python} />
            <Body>
              <Text> Python</Text>
            </Body>
          </ListItem>
          <ListItem
            onPress={() =>
              checkBoxData.javascript
                ? setCheckboxData({ ...checkBoxData, javascript: false })
                : setCheckboxData({ ...checkBoxData, javascript: true })
            }
          >
            <CheckBox checked={checkBoxData.javascript} />
            <Body>
              <Text> Javascript</Text>
            </Body>
          </ListItem>
          <ListItem
            onPress={() =>
              checkBoxData.ruby
                ? setCheckboxData({ ...checkBoxData, ruby: false })
                : setCheckboxData({ ...checkBoxData, ruby: true })
            }
          >
            <CheckBox checked={checkBoxData.ruby} />
            <Body>
              <Text> Ruby</Text>
            </Body>
          </ListItem>
          <ListItem
            onPress={() =>
              checkBoxData.golang
                ? setCheckboxData({ ...checkBoxData, golang: false })
                : setCheckboxData({ ...checkBoxData, golang: true })
            }
          >
            <CheckBox checked={checkBoxData.golang} />
            <Body>
              <Text> GoLang</Text>
            </Body>
          </ListItem>
          <ListItem
            onPress={() =>
              checkBoxData.cplusplus
                ? setCheckboxData({ ...checkBoxData, cplusplus: false })
                : setCheckboxData({ ...checkBoxData, cplusplus: true })
            }
          >
            <CheckBox checked={checkBoxData.cplusplus} />
            <Body>
              <Text> C++</Text>
            </Body>
          </ListItem>
